...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.fill_new_contact(wd, Contact(first_name="1234", middle_name="1243", last_name="234", nick_name="324", title="324234",
    ...
    def test_add_empty_contact(self):
        ...
        self.open_home_page(wd)
        self.login(wd, username="admin", password="secret")
        self.fill_new_contact(wd, Contact(first_name="", middle_name="", last_name="", nick_name="", title="",
    ...
    def fill_new_contact(self, wd, contact):
        ...
        Select(wd.find_element_by_name("new_group")).select_by_visible_text(contact.contacts_group)
