...
def test_add_contact(app):
    app.contact.create_new_contact(Contact(first_name="1234", middle_name="1243", last_name="234", nick_name="324", title="324234",
...
def test_add_empty_contact(app):
    app.contact.create_new_contact(Contact(first_name="", middle_name="", last_name="", nick_name="", title="",
